...
\usepackage{uiomasterfp/uiomasterfp}   % or uiomasterfp/uiomasterfp depending on your folder
...
\begin{document}
	...
	program={Informatics},                        %% ... or your study program
%	supervisor={The Name},                    %% ... or blank
	supervisors={Xing Cai\and James Trotter},     %% if more than one
	long]                                     %% ... or short
