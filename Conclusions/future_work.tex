...
\begin{itemize}
	\item \textbf{RQ1}: Can a partition-aware objective produce better balanced communication loads than a global one?
	\item \textbf{RQ2}: Can the performance of a parallel application be improved in practice by using a partition-aware objective?
\end{itemize}
