...
thesis at the University of Oslo (only for the front page) but 
...
\item Select ``UiO Bachelor's thesis''.
...
\begin{quote}
  \pcmd{documentclass[\emph{options}]}\ppar{uiobachelorthesis}
\end{quote}
Any options are passed to packages you use.

\section{An example}
The \p{uiobachelorthesis} package comes with a base file named
\pb{uiobachelorthesis-base.tex} containing the basic layout of your thesis;
...
\begin{figure}[htp]
  \VerbatimInput[fontsize=\footnotesize,frame=single,obeytabs,
    label={\pb{uiobachelorthesis-base.tex}},numbers=left]{uiobachelorthesis-base.tex}
  \caption{The file \p{uiobachelorthesis-base.tex}\label{fig:base}}
\end{figure}
